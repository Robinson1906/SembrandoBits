...
* `sensores`: nombre (único), activo + tipo\_sensor, campos.nombre\_campo
* `medidas`: sensor\_id + campo\_id + timestamp, timestamp

## 🚀 Despliegue

Para instrucciones detalladas de despliegue en producción, consulta [README\_DEPLOY.md](broken-reference).
